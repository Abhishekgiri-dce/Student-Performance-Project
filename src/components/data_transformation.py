...
class DataTransformationConfig:
    proprocessor_obj_file_path = os.path.join('artifacts',"preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This function shall configure and return a data transformer object.
        '''
        try:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info("Reas train and test data completed")
            ...
            logging.info(
                f"Applying preprocessing object on training dataframee and testing dataframe."
            )
